    ...
    <section className="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
      <div className="grid gap-6">
        <article className="rounded-3xl border border-border bg-[var(--app-surface)] p-6">
          ...
          <h2 className="mt-3 font-heading text-2xl text-foreground">Votes</h2>
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="font-heading text-xl text-foreground">Create vote</h3>
          ...
          {!hasLevels ? (
            <div className="mt-4 rounded-2xl border border-amber-300/20 bg-amber-300/10 px-4 py-4 text-sm text-amber-700 dark:text-amber-100">
      ...
      <article className="rounded-3xl border border-border bg-[var(--app-surface)] p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h3 className="font-heading text-xl text-foreground">Current votes</h3>
            <p className="mt-2 text-sm text-muted-foreground">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="rounded-full border border-cyan-300/15 bg-cyan-300/10 px-2.5 py-1 text-[11px] uppercase tracking-[0.2em] text-cyan-700 dark:text-cyan-100">
                          {vote.tag}
                        </span>
                      </div>
                      {vote.description ? (
